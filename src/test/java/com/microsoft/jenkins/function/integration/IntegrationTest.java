...
public class IntegrationTest {
    ...
    protected static class TestEnvironment {
        ...
        TestEnvironment() {
            subscriptionId = TestEnvironment.loadFromEnv("AZURE_FUNCTION_TEST_SUBSCRIPTION_ID");
            clientId = TestEnvironment.loadFromEnv("AZURE_FUNCTION_TEST_CLIENT_ID");
            clientSecret = TestEnvironment.loadFromEnv("AZURE_FUNCTION_TEST_CLIENT_SECRET");
            oauth2TokenEndpoint = TestEnvironment.loadFromEnv("AZURE_FUNCTION_TEST_TOKEN_ENDPOINT");
            serviceManagementURL = TestEnvironment.loadFromEnv("AZURE_FUNCTION_TEST_AZURE_URL");
            authenticationEndpoint = TestEnvironment.loadFromEnv("AZURE_FUNCTION_TEST_AZURE_AUTH_URL");
            resourceManagerEndpoint = TestEnvironment.loadFromEnv("AZURE_FUNCTION_TEST_AZURE_RESOURCE_URL");
            graphEndpoint = TestEnvironment.loadFromEnv("AZURE_FUNCTION_TEST_AZURE_GRAPH_URL");
            ...
            sd.withSize(TestEnvironment.loadFromEnv("AZURE_FUNCTION_TEST_DEFAULT_PRICING_TIER_SIZE", "D1"));
